...
public class EditStudent {
	...
	public void test1(){
	    ...
	    test.setHiddenField("page","1'> <a href=www.yahoo.fr>malicious link</a><br'");
	   	test.clickElementByXPath("//input[@onClick='document.students.page2.value=21;checkboxes();']");
	    test.assertMatch("Edit Student");
	...
	public void test2(){
		...
		test.assertCheckboxPresent("delete[]");
	 	test.clickElementByXPath("//input[@onClick='updateboxes(1);']");
	    test.setHiddenField("page2","21'> <a href=www.yahoo.fr>malicious link</a><br'");
	   	test.clickElementByXPath("//input[@onClick='document.students.page2.value=21;checkboxes();']");
	    test.assertMatch("Edit Student");
	    test.assertLinkNotPresentWithExactText("malicious link");  
	}
