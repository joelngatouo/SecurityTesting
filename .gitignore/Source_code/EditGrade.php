<?php
 $id = $_POST['delete'];
 $trimmedassignment=intval($_POST['assignment']);
 $query = mysql_query("SELECT submitdate, points, comment, islate, gradeid FROM grades WHERE studentid = '$id[0]' AND assignmentid = '$trimmedassignment'")
