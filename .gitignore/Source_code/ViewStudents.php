...
print("
 ...
 $query = mysql_query("SELECT studentid FROM registrations WHERE courseid = $trimmeselectclass]")
...
print("
  ...
  $query =    mysql_query("SELECT totalpoints, aperc, bperc, cperc, dperc, fperc FROM courses WHERE courseid = $trimmeselectclass")
  ...
  {
   $row++;
   $q = mysql_query("SELECT currentpoints FROM registrations WHERE studentid = '$ids[$i]' AND courseid = $trimmeselectclass");
